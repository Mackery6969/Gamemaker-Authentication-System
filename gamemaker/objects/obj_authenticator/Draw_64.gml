if (! variable_global_exists("antileak_boot_stage")) {
    exit;
}
...
if (global.antileak_boot_stage == "ready") {
    exit;
}
...
switch (global.antileak_boot_stage) {
    ...
    case "update_ready":
        draw_text(
            _midW,
            _midH + 60,
            embed_value_string(lang_get_value_newline("antileak_update_ready"), [program_directory])
        );
        break;
}
